...
import static simulator.AddressMode.ABS;
import static simulator.AddressMode.ABX;
import static simulator.AddressMode.ABY;
import static simulator.AddressMode.ACC;
import static simulator.AddressMode.BAD;
import static simulator.AddressMode.IDX;
import static simulator.AddressMode.IDY;
import static simulator.AddressMode.IMM;
import static simulator.AddressMode.IMP;
import static simulator.AddressMode.IND;
import static simulator.AddressMode.REL;
import static simulator.AddressMode.ZPG;
import static simulator.AddressMode.ZPX;
import static simulator.AddressMode.ZPY;
import static simulator.Mnemonic.ADC;
import static simulator.Mnemonic.AND;
import static simulator.Mnemonic.ASL;
import static simulator.Mnemonic.BCC;
import static simulator.Mnemonic.BCS;
import static simulator.Mnemonic.BEQ;
import static simulator.Mnemonic.BIT;
import static simulator.Mnemonic.BMI;
import static simulator.Mnemonic.BNE;
import static simulator.Mnemonic.BPL;
import static simulator.Mnemonic.BRK;
import static simulator.Mnemonic.BVC;
import static simulator.Mnemonic.BVS;
import static simulator.Mnemonic.CLC;
import static simulator.Mnemonic.CLD;
import static simulator.Mnemonic.CLI;
import static simulator.Mnemonic.CLV;
import static simulator.Mnemonic.CMP;
import static simulator.Mnemonic.CPX;
import static simulator.Mnemonic.CPY;
import static simulator.Mnemonic.DEC;
import static simulator.Mnemonic.DEX;
import static simulator.Mnemonic.DEY;
import static simulator.Mnemonic.EOR;
import static simulator.Mnemonic.HLT;
import static simulator.Mnemonic.INC;
import static simulator.Mnemonic.INX;
import static simulator.Mnemonic.INY;
import static simulator.Mnemonic.JMP;
import static simulator.Mnemonic.JSR;
import static simulator.Mnemonic.LDA;
import static simulator.Mnemonic.LDX;
import static simulator.Mnemonic.LDY;
import static simulator.Mnemonic.LSR;
import static simulator.Mnemonic.NOP;
import static simulator.Mnemonic.ORA;
import static simulator.Mnemonic.PHA;
import static simulator.Mnemonic.PHP;
import static simulator.Mnemonic.PLA;
import static simulator.Mnemonic.PLP;
import static simulator.Mnemonic.ROL;
import static simulator.Mnemonic.ROR;
import static simulator.Mnemonic.RTI;
import static simulator.Mnemonic.RTS;
import static simulator.Mnemonic.SBC;
import static simulator.Mnemonic.SEC;
import static simulator.Mnemonic.SED;
import static simulator.Mnemonic.SEI;
import static simulator.Mnemonic.STA;
import static simulator.Mnemonic.STX;
import static simulator.Mnemonic.STY;
import static simulator.Mnemonic.TAX;
import static simulator.Mnemonic.TAY;
import static simulator.Mnemonic.TSX;
import static simulator.Mnemonic.TXA;
import static simulator.Mnemonic.TXS;
import static simulator.Mnemonic.TYA;
